...
{
    [NUISettings initWithStylesheets:@[
                                       @"YQColorParameter",
                                       @"YQLabelParameter",
                                       @"YQButtonParameter",
                                       @"YQPopMenuParameter",
    ...
    [GJRedDot registWithProfile:@[
                                  @"portraitkey",
                                  @"notificationkey",
                                  ] defaultShow:YES];
    [GJRedDot setDefaultColor:[YQUIDefinitions getColor:@"@Color_Red_500"]];
    
    [[YQResourceManager sharedSingleton] loadResourceWithLanguageCode:@"en"];
